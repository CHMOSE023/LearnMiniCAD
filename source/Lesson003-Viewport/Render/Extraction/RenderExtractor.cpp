...
namespace MiniCAD
{
    ...
    void RenderExtractor::BuildLine(const XMFLOAT3& p0, const XMFLOAT3& p1, std::vector<LineVertex>& out)
    {
    ...
    void RenderExtractor::BuildCircle(const XMFLOAT3& center,  float radius, int segments, std::vector<LineVertex>& out)
    {
